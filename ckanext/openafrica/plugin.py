...
class OpenAfricaPlugin(SingletonPlugin):
	...
	def update_config(self, config):
		...
		our_public_dir = os.path.join(rootdir, 'ckanext','openafrica', 'theme', 'public')
		template_dir = os.path.join(rootdir, 'ckanext','openafrica', 'theme', 'templates')
